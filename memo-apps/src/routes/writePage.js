    ...
    <div className="writepage">
      ...
      <div className="write-container">
        <div className="inputs">
          {titleWarning ? (
            <p className="inputs-p1">
              *제목을 작성해 주세요 (공백X, 10자 이내)
            </p>
          ) : null}
          <input
            type="text"
          ...
          ></input>
          {subtitleWarning ? <p className="inputs-p2">10자 이내</p> : null}
          <input
            type="text"
            value={subTitle}
            name="subTitle"
            placeholder="메모에 대한 설명을 적어주세요 (0 ~ 10자)"
            onChange={(e) => {
